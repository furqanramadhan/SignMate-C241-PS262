...
import com.capstone.signmate_c241_ps262.databinding.ActivityNavigationFragmentBinding
...
class NavigationFragment : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_navigation_fragment)
