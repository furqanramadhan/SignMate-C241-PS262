...
import com.capstone.signmate_c241_ps262.viewmodel.QuizTFViewModel

class PlayNowTF : AppCompatActivity() {
    private lateinit var binding: ActivityPlayNowTfBinding
    private lateinit var viewModel: QuizTFViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this)[QuizTFViewModel::class.java]
