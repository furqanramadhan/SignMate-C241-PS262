...
class QuizNumberViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadQuizQuestions() {
        apiService.getNumberQuizQuestions().enqueue(object : Callback<List<QuizQuestion>> {
