...
class QuizTFViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadQuizQuestions() {
        apiService.getYesOrNoQuizQuestions().enqueue(object : Callback<List<QuizQuestion>> {
